...
class sha256  : public std::array<uint64_t, 4>
{
  public:
    ...
    {
       return (uint32_t)(__builtin_popcountll((*this)[0]) +
                         __builtin_popcountll((*this)[1]) +
                         __builtin_popcountll((*this)[2]) +
                         __builtin_popcountll((*this)[3])); 
    }
  ...
  static_assert( std::is_trivially_copyable_v<sha256> );
  static_assert( sizeof(sha256) == 32, "unexpected memory size" );
