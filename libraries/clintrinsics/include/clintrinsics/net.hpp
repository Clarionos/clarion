...
namespace clintrinsics
{
    ...
    namespace imports
    {
        [[clang::import_module("clarion"), clang::import_name("connect")]] void connect(
            ...
            void *pOnMessage, void (*fOnMessage)(void *pOnMessage, BytesTag *bytesIndex),
            void *pOnClose, void (*fOnClose)(void *pOnClose, uint32_t code),
            void *pOnError, void (*fOnError)(void *pOnError),
            void *p, void (*f)(void *p, ConnectionTag *conn)
        );

        [[clang::import_module("clarion"), clang::import_name("sendMessage")]] void sendMessage(ConnectionTag *conn, const void *messagePos, uint32_t messageLen, void *p, void (*f)(void *p));
    ...
    struct Connection : ExternalObject<ConnectionTag>
    {
        ...
        {
            return callExternalAsync<void, imports::sendMessage>(std::tuple{handle, messagePos, messageLen}, []() {});
        }
        ...
        auto connect()
        {
            return callExternalAsync<void, imports::connect>(std::tuple{
                uri.c_str(), 
                uri.size(),
                // onMessage event
                this,
